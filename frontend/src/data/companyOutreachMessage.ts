// Message copie/colle a destination directe d'une entreprise (page Entreprises), pour les
// boites BIM sans contact humain identifie. Texte fixe, aucun placeholder (validé par Gilles
// le 14/09) : ni prenom (pas de contact nomme) ni nom d'entreprise (retire volontairement).
// Raccourci le 14/09 (576 caracteres) pour tenir sous la limite de 750 caracteres du canal
...
Un outil comme celui-ci, adapté à vos besoins réels, pourrait-il vous intéresser ?
