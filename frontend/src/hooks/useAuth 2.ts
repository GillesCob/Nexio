...
import type { IAuthResponse, ILoginPayload, IRegisterPayload, IForgotPasswordPayload } from "@/types/auth";
...
export function useLogin() {
  ...
  return useMutation({
    mutationFn: (payload: ILoginPayload) => apiClient.post<IAuthResponse>("/auth/login", payload).then((r) => r.data),
